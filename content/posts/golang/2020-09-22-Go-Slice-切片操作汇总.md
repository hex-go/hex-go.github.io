...
设计意图：需求远超当前容量，<mark>一次分配到位最有效率，避免多次扩容和拷贝</mark>。即使原切片已很大，大幅跳跃仍应直接分配——平滑扩容在此场景下反而低效。
...
设计意图：小切片翻倍浪费有限，但能大幅减少未来扩容次数——<mark>用空间换时间</mark>。
...
设计意图：大切片若翻倍浪费严重，故采用增长因子从 2 逐渐降至 1.25 的公式，<mark>适度预留空间，平衡未来扩容次数与内存占用</mark>。
