...
详见 [K8s 存储-Volume 生命周期全解析](/posts/kubernetes/k8s存储-volume生命周期全解析/)。
...
详见 [FlexVolume 与 CSI 演进](/posts/kubernetes/k8s存储-flexvolume与csi演进/) 和 [CSI 架构详解](/posts/kubernetes/k8s存储-csi架构详解/)。
