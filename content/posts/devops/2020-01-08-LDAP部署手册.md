...
![image](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/MyO8lo.jpg)
...
![ldap-deploy-1](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/0SSMWF.jpg)

点击上图3号位置，配置lam。如下图所示，点击`Edit server profiles`

![ldap-deploy-2](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/QpMdKB.jpg)

提示输入Lam密码，默认密码`lam`，可自行修改。登录后如下图做相应修改:

![ldap-deploy-3](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/2DruJa.jpg)

修改一下默认的管理员帐号：

![ldap-deploy-4](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/jhDS2p.jpg)

接下来是修改默认创建的两个组，这两个会在首次登陆系统时提示创建

![ldap-deploy-5](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/AgJ3cZ.jpg)

保存后，登陆系统

![ldap-deploy-6](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/noMv7D.jpg)

提示创建默认的组:

![ldap-deploy-7](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/VJHUYS.jpg)

![ldap-group+user](https://hex-cdn.oss-cn-hangzhou.aliyuncs.com/old/q8IWEc.jpg)
